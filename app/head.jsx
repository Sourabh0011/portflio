export default function Head({ currentPage = "Home" }) {
  const pageTitle = `${
    currentPage === "Home"
      ? "Sourabh Sharma - Web Developer, Designer and Creator."
      : `${currentPage} - Sourabh Sharma`
  }`;
  const desc =
  ...
  return (
    <>
      ...
      <meta
        name="keywords"
        content="Sourabh Sharma, sourabh sharma, freelancers, react developer, reactjs freelancer, nextjs"
      />
      ...
      />
      <link rel="manifest" href={`${process.env.NEXT_PUBLIC_BASE_URL}static/favicon/site.webmanifest`} />
      <link rel="canonical" href="https://sourabhsharma.js.org/" />
      <meta name="title" content={pageTitle} />
      <meta name="description" content={desc} />

      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://sourabhsharma.js.org/" />
      <meta property="og:title" content={pageTitle} />
      <meta property="og:description" content={desc} />
      <meta
        property="og:image"
        content="https://sourabhsharma.js.org/static/misc/og.png"
      />

      <meta property="twitter:card" content="summary_large_image" />
      <meta property="twitter:url" content="https://sourabhsharma.js.org/" />
